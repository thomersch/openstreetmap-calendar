...
def auth_initialize():
    session = OAuth1Session(_get_config_value("client_key"), _get_config_value("client_secret"))
    req_tokens = session.fetch_request_token(request_token_url, data={"x_auth_access_type": "write"})
